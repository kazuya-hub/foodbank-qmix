...
# で述べた、エージェントの振る舞いを観察するために使用したコード
...
def profile():
    # file_path = ""
    sacred_results_dir = os.path.join(os.getcwd(), "../results/sacred")
    file_path = os.path.join(sacred_results_dir, "379/run_full.log")
    # while not os.path.exists(file_path):
    #     file_path = os.path.abspath(
    #         os.path.join(
    #             sacred_results_dir, f"{random.randint(1, 1392)}/run_full.log"
    #         )
    #     )
    ...
    #     file_path = os.path.abspath(
    #         os.path.join(sacred_results_dir, f"{i}/run_full.log")
    #     )
    #     print(file_path)
